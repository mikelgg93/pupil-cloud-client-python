...
from openapi_client.models.recording_get_response import RecordingGetResponse

class TestRecordingGetResponse(unittest.TestCase):
    """RecordingGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecordingGetResponse:
        """Test RecordingGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecordingGetResponse`
        """
        model = RecordingGetResponse()
        if include_optional:
    ...
    def testRecordingGetResponse(self):
        """Test RecordingGetResponse"""
