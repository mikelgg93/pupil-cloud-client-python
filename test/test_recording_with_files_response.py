...
from openapi_client.models.recording_with_files_response import RecordingWithFilesResponse

class TestRecordingWithFilesResponse(unittest.TestCase):
    """RecordingWithFilesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecordingWithFilesResponse:
        """Test RecordingWithFilesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecordingWithFilesResponse`
        """
        model = RecordingWithFilesResponse()
        if include_optional:
            return RecordingWithFilesResponse(
    ...
    def testRecordingWithFilesResponse(self):
        """Test RecordingWithFilesResponse"""
