...
from openapi_client.models.wearer import Wearer

class TestWearer(unittest.TestCase):
    """Wearer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Wearer:
        """Test Wearer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Wearer`
        """
        model = Wearer()
        if include_optional:
            return Wearer(
