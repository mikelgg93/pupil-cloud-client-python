...
class ProjectEnrichmentResourcePatchResponse(BaseModel):
    """
    ProjectEnrichmentResourcePatchResponse
    """ # noqa: E501
    code: Optional[Union[StrictFloat, StrictInt]] = None
    result: Optional[ProjectEnrichment] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "result": ProjectEnrichment.from_dict(obj["result"]) if obj.get("result") is not None else None,
