...
class FixationDatapoint(BaseModel):
    """
    FixationDatapoint
    """ # noqa: E501
    end_timestamp: Optional[Union[StrictFloat, StrictInt]] = None
    fixation_id: Optional[StrictInt] = None
    seek_timestamp: Optional[Union[StrictFloat, StrictInt]] = None
    start_timestamp: Optional[Union[StrictFloat, StrictInt]] = None
    updated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["end_timestamp", "fixation_id", "seek_timestamp", "start_timestamp", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seek_timestamp": obj.get("seek_timestamp"),
