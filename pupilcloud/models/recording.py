...
class Recording(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["android_gaze_offset", "app_version", "created_at", "created_by_user_id", "device_model", "device_name", "duration_ns", "family", "gaze_offset", "gaze_offset_x", "gaze_offset_y", "gazepipeline_status", "glasses_id", "has_scanpath", "id", "is_blurred", "is_processed", "is_silent", "is_uploaded", "is_viewable", "label_ids", "name", "preprocessing_error_message", "recorded_at", "recording_hash", "scene_camera_id", "sensors", "size", "template_data", "template_id", "thumbnail_url", "transcoded_url", "transcoding_status", "trashed_at", "trashed_by_user_id", "updated_at", "uploaded_bytes", "wearer_id", "workspace_id"]
    ...
    def family_validate_enum(cls, value):
        ...
        if value not in set(['i', 'n', 'v', 'i', 's', 'i', 'b', 'l', 'e']):
            raise ValueError("must be one of enum values ('i', 'n', 'v', 'i', 's', 'i', 'b', 'l', 'e')")
        return value
    ...
    def gazepipeline_status_validate_enum(cls, value):
        ...
        if value not in set(['queued', 'processing', 'done', 'error', 'n/a']):
            raise ValueError("must be one of enum values ('queued', 'processing', 'done', 'error', 'n/a')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "android_gaze_offset": OffsetCorrection.from_dict(obj["android_gaze_offset"]) if obj.get("android_gaze_offset") is not None else None,
            ...
            "gaze_offset": OffsetCorrection.from_dict(obj["gaze_offset"]) if obj.get("gaze_offset") is not None else None,
            ...
            "has_scanpath": obj.get("has_scanpath") if obj.get("has_scanpath") is not None else False,
            "id": obj.get("id"),
            "is_blurred": obj.get("is_blurred") if obj.get("is_blurred") is not None else False,
