...
class GazeDatapoint(BaseModel):
    ...
    GazeDatapoint
    """ # noqa: E501
    blink_id: Optional[StrictInt] = None
    ...
    worn: Optional[StrictInt] = None
    x: Optional[StrictInt] = None
    y: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["blink_id", "end_timestamp", "fixation_id", "start_timestamp", "worn", "x", "y"]
