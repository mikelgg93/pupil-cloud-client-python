...
class RecordingFixationsTimelineGetResponse(BaseModel):
    """
    RecordingFixationsTimelineGetResponse
    """ # noqa: E501
    code: Optional[Union[StrictFloat, StrictInt]] = None
    result: Optional[List[FixationsTimeline]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "result": [FixationsTimeline.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
