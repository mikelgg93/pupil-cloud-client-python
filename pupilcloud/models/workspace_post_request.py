...
class WorkspacePostRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alpha_features", "created_at", "default_template_id", "deleted_at", "id", "name", "picture_url", "plan_id", "raw_file_downloads", "status", "updated_at", "world_video_mode"]
