...
class TokensGetResponse(BaseModel):
    """
    TokensGetResponse
    """ # noqa: E501
    code: Optional[Union[StrictFloat, StrictInt]] = None
    result: Optional[List[Token]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "result": [Token.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
