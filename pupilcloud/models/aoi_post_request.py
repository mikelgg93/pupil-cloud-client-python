...
class AoiPostRequest(BaseModel):
    """
    AoiPostRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["bounding_box", "centroid_xy", "color", "created_at", "description", "enrichment_id", "id", "mask_image_data_url", "name", "updated_at"]
