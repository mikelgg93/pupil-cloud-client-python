...
class ProjectEnrichmentPatchRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["args", "created_at", "from_event_name", "id", "kind", "name", "project_id", "to_event_name", "updated_at"]
    ...
    def kind_validate_enum(cls, value):
        ...
        if value not in set(['marker-mapper', 'slam-mapper', 'render', 'raw-data-export', 'face-mapper']):
            raise ValueError("must be one of enum values ('marker-mapper', 'slam-mapper', 'render', 'raw-data-export', 'face-mapper')")
        return value
