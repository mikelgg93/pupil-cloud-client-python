...
class ProjectRecording(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["events", "project_id", "recording_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [ProjectEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
