...
class StaticImageMapperEnrichmentsRecordingFixationsGetResponse(BaseModel):
    """
    StaticImageMapperEnrichmentsRecordingFixationsGetResponse
    """ # noqa: E501
    code: Optional[Union[StrictFloat, StrictInt]] = None
    result: Optional[RecordingFixations] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "result": RecordingFixations.from_dict(obj["result"]) if obj.get("result") is not None else None,
