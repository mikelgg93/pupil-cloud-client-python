...
class RecordingSceneCameraIntrinsicsGetResponse(BaseModel):
    """
    RecordingSceneCameraIntrinsicsGetResponse
    """ # noqa: E501
    code: Optional[Union[StrictFloat, StrictInt]] = None
    result: Optional[SceneCameraIntrinsics] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "result": SceneCameraIntrinsics.from_dict(obj["result"]) if obj.get("result") is not None else None,
