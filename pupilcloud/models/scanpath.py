...
class Scanpath(BaseModel):
    ...
    path: Optional[List[ScanpathPoint]] = None
    start_timestamp: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["end_timestamp", "path", "start_timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": [ScanpathPoint.from_dict(_item) for _item in obj["path"]] if obj.get("path") is not None else None,
